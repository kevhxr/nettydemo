...
public class SyncWriteFuture implements WriteFuture<MyResponse> {
    ...
    @Override
    public MyResponse get() throws InterruptedException, ExecutionException {
        latch.wait();
        return response;
    }

    @Override
    public MyResponse get(long timeout, TimeUnit unit) throws InterruptedException, ExecutionException, TimeoutException {
